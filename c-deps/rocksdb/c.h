...
rocksdb_options_set_create_missing_column_families(rocksdb_options_t*,
                                                   unsigned char);
extern ROCKSDB_LIBRARY_API void rocksdb_options_set_recover_lease_during_open(rocksdb_options_t*,
                                                   unsigned char);
...
extern ROCKSDB_LIBRARY_API rocksdb_env_t* rocksdb_create_stream_env();
